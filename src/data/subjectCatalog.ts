...
import { getLessonSummary } from './lessonSummaries';
        ...
        items: [
          {
            ...
            language: 'es',
            ...getLessonSummary('sad-session-0'),
          ...
          },
          {
            ...
            language: 'es',
            ...getLessonSummary('sad-session-1'),
          ...
          },
          {
            ...
            language: 'es',
            ...getLessonSummary('sad-session-2'),
          ...
          },
          {
            ...
            language: 'es',
            ...getLessonSummary('sad-session-3'),
        ...
        items: [
          {
            ...
            language: 'es',
            ...getLessonSummary('dbd-presentacion'),
            tags: ['orientación'],
        ...
        items: [
          {
            ...
            language: 'en',
            ...getLessonSummary('snlp-chapter-1'),
            tags: ['fundamentals'],
            estimatedMinutes: withMinutes(60),
            dueDate: toIsoDate(-6),
            status: 'graded',
          },
          {
            ...
            language: 'en',
            ...getLessonSummary('snlp-chapter-2'),
          ...
          },
          {
            ...
            language: 'en',
            ...getLessonSummary('snlp-chapter-3'),
          ...
          },
          {
            ...
            language: 'en',
            ...getLessonSummary('snlp-chapter-4'),
          ...
          },
          {
            ...
            language: 'en',
            ...getLessonSummary('snlp-chapter-5'),
            tags: ['LLM', 'evaluación'],
            estimatedMinutes: withMinutes(80),
          ...
          },
          {
            ...
            language: 'en',
            ...getLessonSummary('snlp-chapter-6'),
        ...
        items: [
          {
            ...
            language: 'en',
            ...getLessonSummary('admeav-slide-t0'),
            tags: ['orientación'],
            estimatedMinutes: withMinutes(40),
            dueDate: toIsoDate(-8),
            status: 'graded',
          },
          {
            ...
            language: 'en',
            ...getLessonSummary('admeav-slide-t1'),
          ...
          },
          {
            ...
            language: 'en',
            ...getLessonSummary('admeav-slide-t2'),
