        ...
        items: [
          {
            ...
            language: 'es',
            summary: {
              original: 'Agenda, criterios de evaluación y repositorio de documentación.',
              english: 'High-level agenda, grading policy, and document sources.',
            },
            ...
            translation: {
              status: 'partial',
              summary: 'Notas en inglés capturando los hitos principales y vocabulario crítico.',
            },
          },
          {
            id: 'sad-session-1',
            ...
            language: 'es',
            summary: {
              original: 'Repaso de drivers arquitectónicos, capas y tácticas básicas.',
              english: 'Drivers, layered styles, and starter tactics distilled into English bullets.',
            },
            ...
            translation: {
              status: 'partial',
              summary: 'Glosario inglés-español con los conceptos esenciales.',
            },
          },
          {
            id: 'sad-session-2',
            ...
            language: 'es',
            summary: {
              original: 'Ventajas, riesgos y observabilidad en arquitecturas de microservicios.',
              english: 'Risks, boundaries, and observability notes captured en inglés para repaso rápido.',
            },
            ...
            translation: {
              status: 'partial',
              summary: 'Resumen en inglés con tablas de decisiones y métricas clave.',
            },
          },
          {
            id: 'sad-session-3',
            ...
            language: 'es',
            summary: {
              original: 'Comparativa de IaaS, PaaS y SaaS con énfasis en riesgos.',
              english: 'English recap covering service models, shared responsibility, and governance notes.',
            },
            ...
            translation: {
              status: 'planned',
              summary: 'Pendiente de sintetizar en inglés tras la clase.',
            },
          },
        ],
      },
        ...
        items: [
          {
            ...
            language: 'es',
            summary: {
              original: 'Marco inicial, objetivos y pilares del gobierno de TI.',
              english: 'Introductory overview highlighting governance pillars and control objectives.',
            },
            ...
            translation: {
              status: 'partial',
              summary: 'Notas en inglés con paralelos a marcos PMI y COBIT.',
            },
          },
          {
            id: 'ggo-tema-2',
            ...
            language: 'es',
            summary: {
              original: 'Modelos de valor y métricas económicas para evaluar TI.',
              english: 'Value management concepts rewritten in English with metric cheatsheets.',
            },
            tags: ['valor', 'métricas'],
            estimatedMinutes: withMinutes(80),
            dueDate: toIsoDate(1),
            ...
            translation: {
              status: 'partial',
              summary: 'Checklist bilingüe para mapear beneficios a indicadores.',
            },
          },
          {
            id: 'ggo-tema-3',
            ...
            language: 'es',
            summary: {
              original: 'Proceso Bedell, matriz de contribución y criterios de priorización.',
              english: 'Bedell alignment method summarised in English flow steps.',
            },
            ...
            translation: {
              status: 'partial',
              summary: 'Traducción en progreso con ejemplos de puntuación.',
            },
          },
          {
            ...
            language: 'es',
            summary: {
              original: 'Rellenar la hoja oficial para calcular la importancia del sistema de información.',
              english: 'Complete the Bedell worksheet translating key steps into English prompts.',
            },
          ...
          },
          {
            ...
            language: 'es',
            summary: {
              original: 'Documento guiado para clasificar stakeholders y evaluar su impacto.',
              english: 'Guided template with English helper notes for each stakeholder quadrant.',
            },
        ...
        items: [
          {
            ...
            language: 'es',
            summary: {
              original: 'Descripción general del temario, evaluación y calendario.',
              english: 'Course roadmap and grading scheme translated into English notes.',
            },
            tags: ['orientación'],
            ...
            translation: {
              status: 'partial',
              summary: 'Resumen en inglés con los hitos clave.',
            },
          },
          {
            id: 'dbd-tema-1',
            ...
            language: 'es',
            summary: {
              original: 'Modelado entidad-relación, restricciones y casos prácticos.',
              english: 'ER modelling recap written in English for quick drilling.',
            },
            tags: ['modelado', 'ER'],
            ...
            translation: {
              status: 'partial',
              summary: 'Glosario inglés-español con entidades y cardinalidades.',
            },
          },
          {
            id: 'dbd-tema-2',
            ...
            language: 'es',
            summary: {
              original: 'Formas normales, dependencias funcionales y síntesis de tablas.',
              english: 'English cheat notes covering FN1-FN3 and decomposition patterns.',
            },
            ...
            translation: {
              status: 'partial',
              summary: 'Checklist bilingüe para identificar anomalías de actualización.',
            },
          },
          {
        ...
        items: [
          {
            ...
            language: 'en',
            summary: {
              original: 'Foundational NLP timeline and pipeline overview.',
              english: 'Same as original; slides already in English.',
            },
            tags: ['fundamentals'],
            estimatedMinutes: withMinutes(60),
            dueDate: toIsoDate(-6),
            ...
            translation: {
              status: 'complete',
              summary: 'Notas en español para vocabulario clave.',
            },
          },
          {
            id: 'snlp-chapter-2',
            ...
            language: 'en',
            summary: {
              original: 'n-gram models, smoothing, and evaluation metrics.',
            },
            ...
            translation: {
              status: 'complete',
              summary: 'Glosario español-inglés de métricas y algoritmos.',
            },
          },
          {
            id: 'snlp-chapter-3',
            ...
            language: 'en',
            summary: {
              original: 'Deep learning workflows with Keras layers and embeddings.',
            },
            ...
            translation: {
              status: 'partial',
              summary: 'Notas en español enfocadas en hiperparámetros.',
            },
          },
          {
            id: 'snlp-chapter-4',
            ...
            language: 'en',
            summary: {
              original: 'Pipelines, evaluation and deployment considerations.',
            },
            ...
            translation: {
              status: 'planned',
              summary: 'Plan de traducción para incorporar casos en español.',
            },
          },
          {
            id: 'snlp-chapter-5',
            ...
            language: 'en',
            summary: {
              original: 'Scaling laws, prompting and evaluation of LLMs.',
            },
            tags: ['LLM', 'evaluación'],
            estimatedMinutes: withMinutes(80),
            ...
            translation: {
              status: 'planned',
              summary: 'Glosario bilingüe pendiente con términos emergentes.',
            },
          },
          {
            id: 'snlp-chapter-6',
            ...
            language: 'en',
            summary: {
              original: 'Speech features, acoustic models and evaluation metrics.',
            },
            ...
            translation: {
              status: 'planned',
              summary: 'Notas en español planificadas tras completar el capítulo.',
            },
          },
          {
        ...
        items: [
          {
            ...
            language: 'en',
            summary: {
              original: 'Course overview, evaluation scheme, and tooling expectations.',
            },
            tags: ['orientación'],
            estimatedMinutes: withMinutes(40),
            dueDate: toIsoDate(-8),
            ...
            translation: {
              status: 'complete',
              summary: 'Resumen en español con hitos y herramientas.',
            },
          },
          {
            id: 'admeav-slide-t1',
            ...
            language: 'en',
            summary: {
              original: 'LBP, HOG, and colour descriptors for classical pipelines.',
            },
            ...
            translation: {
              status: 'partial',
              summary: 'Notas en español sobre parámetros y casos de uso.',
            },
          },
          {
            id: 'admeav-slide-t2',
            ...
            language: 'en',
            summary: {
              original: 'Transfer learning strategies and common CNN architectures.',
            },
            ...
            translation: {
              status: 'planned',
              summary: 'Preparando notas en español con ejemplos de arquitectura.',
            },
          },
        ],
      },
        ...
        items: [
          {
            ...
            language: 'en',
            summary: {
              original: 'Notebook guiado para implementar y comparar técnicas clásicas.',
            },
          ...
          },
          {
            ...
            language: 'en',
            summary: {
              original: 'Example exploring Grey Level Co-occurrence Matrix features.',
            },
            tags: ['GLCM', 'texture'],
            estimatedMinutes: withMinutes(70),
            dueDate: toIsoDate(5),
          ...
          },
          {
            ...
            language: 'en',
            summary: {
              original: 'Hands-on tutorial implementing LBP descriptors.',
            },
          ...
          },
          {
            ...
            language: 'en',
            summary: {
              original: 'Step-by-step pipeline using SIFT keypoints.',
            },
            tags: ['SIFT', 'visión'],
            estimatedMinutes: withMinutes(80),
            dueDate: toIsoDate(9),
